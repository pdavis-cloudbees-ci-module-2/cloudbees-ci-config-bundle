...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/pdavis-cloudbees-ci-module-2/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>pdavis-cloudbees-ci-module-2</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>pdavis-cloudbees-ci-module-2</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/pdavis-cloudbees-ci-module-2/pipeline-template-catalog.git</repositoryUrl>
              <traits>
